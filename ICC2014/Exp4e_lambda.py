...
plot(lam_q,total_cost_list_alllocal,color='black', linestyle='--', fillstyle='none',marker='^',label='LOC')
plot(lam_q,total_cost_list_allremote,color='blue', linestyle='--', fillstyle='none',marker='^',label='OFF')
...
subplots_adjust(top=0.93,bottom=0.16,left=0.16, right=0.95)
legend(loc='best')
ylim([74,106])
show()
